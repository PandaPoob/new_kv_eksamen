      ...
      >
        ...
        <Box>
          <Heading as="h3" size={"heading4"} mb="1rem">
            Veterinærsygeplejerske Karina Dillon skriver Kattens Værdier i
            testamentet
          </Heading>
          <Text>
            Veterinærsygeplejerske Karina Dillon fortæller i Go’ Morgen Danmark
            om at hun har testamenteret sine penge til Kattens Værdier og om de
